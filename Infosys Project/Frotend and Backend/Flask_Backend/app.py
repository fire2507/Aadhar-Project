...
classifier = YOLO(r'C:\Users\user\Desktop\Infosys Project\Frotend and Backend\Flask_Backend\models\classification.pt')
detector = YOLO(r'C:\Users\user\Desktop\Infosys Project\Frotend and Backend\Flask_Backend\models\detection.pt')
reader = Reader(['en'])
